    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={footer}>
            Este código expira em breve. Se não solicitou este código, ignore este email.<br />
...
const codeStyle = { fontFamily: "'DM Sans', Courier, monospace", fontSize: '28px', fontWeight: 'bold' as const, color: '#042D45', margin: '0 0 30px', letterSpacing: '6px' }
