                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3 text-sm">
                     ...
                     {(e.inscription_fee_cents > 0 || e.tuition_installment_cents > 0 || e.summercamp_installment_cents > 0) && (
                      <div className="mt-3 pt-3 border-t border-border">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                          <Detail label="Matrícula" value={`$${(e.inscription_fee_cents / 100).toFixed(0)}`} />
                          <Detail label={`Plataforma Online (${e.tuition_installments}x)`} value={`$${(e.tuition_installment_cents / 100).toFixed(0)}`} />
