  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 text-[11px] text-secondary hover:text-secondary/80 font-medium transition-colors"
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div>
              <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Inscrição</Label>
              <div className="mt-1">
                <Input
                  type="number"
                  step="0.01"
