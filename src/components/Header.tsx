    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-primary/95 backdrop-blur-md border-b border-primary-foreground/10">
      <div className="container-narrow flex items-center justify-between h-16 px-4 md:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link
            to="/login"
            className="text-sm font-semibold text-primary-foreground border border-primary-foreground/30 px-5 py-2.5 rounded-lg hover:bg-primary-foreground/10 transition-colors"
          >
            Entrar
          </Link>
        </nav>
