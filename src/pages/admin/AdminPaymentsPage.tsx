              ...
              <div key={e.id} className={`bg-card rounded-xl border-2 overflow-hidden transition-colors ${isExpanded ? "border-primary shadow-[0_0_0_1px_hsl(var(--primary)/0.2)]" : "border-border"}`}>
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 border-t border-border">
                    ...
                    {insts.length === 0 ? (
                      <p className="text-sm text-muted-foreground text-center py-4">Sem mensalidades registradas.</p>
                    ) : (
                                ...
                                <tr key={inst.id} className="border-b border-border/50 last:border-0">
                                  ...
                                  <td className="py-2 pr-2">
                                    ...
                                    >
                                      ...
                                      >
                                        <div className="flex items-center gap-1">
                                          {inst.status === "overdue" && <AlertTriangle className="h-3 w-3 shrink-0" style={{ color: "#F9B91D" }} />}
                                          <SelectValue />
                                        </div>
                                      </SelectTrigger>
                                      <SelectContent>
